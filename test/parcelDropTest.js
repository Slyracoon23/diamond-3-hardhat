...
describe('DiamondTest', async function () {
  ...
  describe('CityDAO Drop Test', async function () {


    it('should add CityDAOParcelDrop functions', async () => {
      const ParcelDropFacet = await ethers.getContractFactory('CityDAOParcelFacet');
      const CityDAOParcelFacet_deploy = await ParcelDropFacet.deploy();
      await CityDAOParcelFacet_deploy.deployed();
      // Save address in array
      addresses.push(CityDAOParcelFacet_deploy.address);
    
      // Get function selectors from ABI -- Can remove or add functions
      const selectors = getSelectors(CityDAOParcelFacet_deploy);



      // Execute Transaction DimondCut to add your functions
      tx = await diamondCutFacet.diamondCut(
        [{
          facetAddress: CityDAOParcelFacet_deploy.address,
      ...
      result = await diamondLoupeFacet.facetFunctionSelectors(CityDAOParcelFacet_deploy.address)
      assert.sameMembers(result, selectors)
